---
title: "LOO-PIT: A Visual Tool for Bayesian Model Calibration"
...
> For a deeper dive into PSIS-LOO itself, see my companion post: _[Understanding PSIS-LOO for Bayesian Models]()_.
...
To make these ideas concrete, we simulate synthetic predictions. We draw samples from a known “data-generating” distribution, then compute CDF values under a model’s predictive distribution. By manipulating the model's assumptions (e.g., narrower or wider spread, shifted mean), we generate different calibration failure modes.

Each of the following four panels shows a different case:
- **Top left**: well-calibrated — PIT values are uniform.
- **Top right**: underdispersed — model is overconfident, resulting in U-shape.
- **Bottom right**: overdispersed — model is too uncertain, hump-shaped PIT.
- **Bottom left**: biased — predictive distribution systematically misaligned.

::: {.cell}
![Simulated LOO-PIT histograms showing four canonical calibration behaviors.](simulated_loo_pit_scenarios.png)
:::
