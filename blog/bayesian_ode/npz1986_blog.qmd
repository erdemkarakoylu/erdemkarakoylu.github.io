...
subtitle: Obtaining uncertainty-aware parameter estimates for a NPZ model using Bayesian inference.
author: Erdem Karaköylü
date: '2025-03-16'
description: Obtaining uncertainty-aware parameter estimates for a NPZ model using Bayesian inference.
categories:
  - Bayesian Inference
